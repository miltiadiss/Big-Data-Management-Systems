...
try:
    ...
    for message in consumer:
        ...
        # Group by 'link' only to aggregate vcount correctly
        result_df = accumulated_df.groupBy("link") \
            .agg(
        ...
        result_df.show(truncate=False)  # Show the DataFrame without truncating
